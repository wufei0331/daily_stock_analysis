...
```json
{
    ...
    "key_points": "3-5个核心看点，逗号分隔",
    "risk_warning": "风险提示",
    "buy_reason": "操作理由，引用激活技能或风险框架。你【必须】严格从以下 5 个原版实战策略中，精选【最符合该股票当前走势的 1 到 2 个策略】进行深度诊断，明确写在这里：\n1. 缩量回踩：前提(MA5>MA10>MA20)，信号(回踩MA5/MA10附近且成交量<5日均量的70%)，结论(若守住支撑为极佳买点)。\n2. 底部放量：前提(跌幅>15%)，信号(极度缩量后突发>5日均量3倍且收阳企稳)，结论(提示左侧潜在反转)。\n3. 箱体震荡：信号(识别近60日未破的顶底)，结论(距支撑<=5%看多，距阻力<=5%看空)。\n4. 波浪理论：识别浪型，重点排查2浪回调企稳或3浪放量突破；B浪反弹提示陷阱风险，5浪提示顶背离风险。\n5. 缠论：识别中枢震荡或趋势，最高优先级寻找底背驰(创新低但MACD绿柱缩小，提示一买)或顶背驰(坚决提示卖出)。",
